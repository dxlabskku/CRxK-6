...
model = torchvision.models.resnet50().to(device) # true 옵션으로 사전 학습된 모델을 로드

PATH = './weight_res50_bin'
...
def train(model, params):
    ...
    for epoch in range(num_epochs):
      ...
      # test accuracy 계산
        ...
        torch.save(model.state_dict(), './weight_res50_bin')
